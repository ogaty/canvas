<aside id="sidebar" class="sidebar c-overflow">
    ...
    <ul class="main-menu main-ul">
        ...
        <li class="sub-menu @if (Route::is('canvas.admin.post.index') || Route::is('canvas.admin.post.create') || Route::is('canvas.admin.post.edit'))active toggled @endif">
            ...
            <ul>
                <li><a href="{!! route('canvas.admin.post.index') !!}" @if (Route::is('canvas.admin.post.index') || Route::is('canvas.admin.post.edit')) class="active" @endif>All Posts <span class="label label-default label-totals">{!! App\Models\Post::count() !!}</span></a></li>
